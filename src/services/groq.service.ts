...
2. Gunakan format Markdown khas WhatsApp (*bold* untuk kata kunci, _italic_, dan emoji edukatif 💡, ✏️, 🌟).
...
5. HANYA layani pertanyaan seputar pendidikan dan mata pelajaran.
`;
