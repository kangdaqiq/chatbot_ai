...
Jika materi yang kamu jelaskan adalah siklus (seperti siklus air/awan, fotosintesis, rantai makanan, metamorfosis), alur proses, bangun ruang/geometri, grafik fungsi, atau jika siswa meminta gambar/diagram, sertakan tag diagram berikut sebelum tag XP_EVAL:
- Flowchart Siklus / Proses Sains: [DIAGRAM:{"type":"flowchart","data":{"code":"graph TD\n  A[\"☀️ 1. Evaporasi\"] --> B[\"☁️ 2. Kondensasi\"]\n  B --> C[\"🌧️ 3. Presipitasi\"]\n  C --> D[\"🌊 4. Infiltrasi\"]\n  D --> A"}}]
